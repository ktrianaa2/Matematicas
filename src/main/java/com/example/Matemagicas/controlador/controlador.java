...
public class controlador {
    ...
    public ModelAndView administradorView() {
        ModelAndView modelo = new ModelAndView("administrador");
        return modelo;
    }

    @GetMapping("/perfiladministrador")
    public ModelAndView perfilAdministradorView() {
        ModelAndView modelo = new ModelAndView("perfiladministrador");
        return modelo;
    }
